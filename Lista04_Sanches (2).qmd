...
##Hands-On 1. Exiba todas as informações de qualquer reserva natural que possua um número de reserva no conjunto {2, 4, 6, 8, 10}.
...
```{sql connection=con}
SELECT * FROM EMPLOYEE
WHERE SALARY >= 550 AND SALARY <= 2000
```
